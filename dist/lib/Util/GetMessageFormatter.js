...
var _formatText=formatText(message,dataStore);const text=_formatText.text,entities=_formatText.entities;// テキストを置換する
// 投稿結果オブジェクトを返す
...
text=h.unescape(text);return{text,entities:{reply:replyList,channel:channelList,others:othersList}};}function tagReplacerCallback($0,$1,$2){const targetList=this.targetList,finder=this.finder;// IDからオブジェクトを特定する
